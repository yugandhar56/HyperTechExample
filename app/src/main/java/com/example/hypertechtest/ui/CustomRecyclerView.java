...
import com.example.hypertechtest.service.DownloadService;
...
import static com.example.hypertechtest.util.Utils.getString;
                    ...
                    for (int i = firstVisiblePosition; i <= lastVisiblePosition; i++) {
                        ...
                        try {
                            ...
                            if (i >= 0 && cvh != null && cvh.getVideoUrl() != null && !cvh.getVideoUrl().equalsIgnoreCase("null") && (cvh.getVideoUrl().endsWith(".mp4") || !checkForMp4)) {
                                ...
                                cvh.getVideoImage().getLocationOnScreen(location);
                                Rect rect_child = new Rect(location[0], location[1], location[0] + cvh.getVideoImage().getWidth(), location[1] + cvh.getVideoImage().getHeight());
